...
if DEBUG
    ...
    save('db_theta.mat','db_theta');   
    
    [cost grad] = cnnCost2(db_theta,db_images,db_labels,numClasses,...
                                db_filterDim,db_numFilters,db_poolDim);
    

    % Check gradients
    numGrad = computeNumericalGradient( @(x) cnnCost2(x,db_images,...
...
opttheta = minFuncSGD(@(x,y,z) cnnCost2(x,y,z,numClasses,filterDim,...
